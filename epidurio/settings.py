# Django settings for epidurio project.
import os
import sys
...
SECRET_KEY = 'u0fds(ie9(%+vi1d*r8#9m7u7(08=#$+635%$#$uvdk2$a7asg'
...
ROOT_URLCONF = 'epidurio.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'epidurio.wsgi.application'
...
COVERAGE_EXCLUDE_MODULES = ('epidurio.migrations', 'epidurio.tests',
                            'epidurio.local_settings',
